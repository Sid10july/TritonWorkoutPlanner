...
describe("Customize Workout Plan Tests", () => {
  test('all days initialized as unchecked', () => {
    ...
    daysOfWeek.forEach(day => { //iterate through days of the week
  ...
  test('Setting start and end time for a day works as intended', () => {
    ...
    const startTime = document.querySelector(`#${day}-start-time`) as HTMLInputElement;
    const endTime = document.querySelector(`#${day}-end-time`) as HTMLInputElement;
