...
import { daysOfWeek, recommendedExercises } from "../constants"
import '../App.css';
...
export const BuildYourOwn = () => {
    ...
    return (
        <div className="build-your-own">
            ...
            <iframe title="workout customization form"
            ...
            <div className="generated-plan">
                ...
                {daysOfWeek.map(day => (
                    <div key={day} className="day-selection">
                        ...
                        <Dropdown 
                            id={day} 
                            options={focusCategory ? recommendedExercises[focusCategory as keyof typeof recommendedExercises] : []} 
                            value={weeklyPlan[day]} 
                            onChange={(e: React.ChangeEvent<HTMLSelectElement>) => handleExerciseChange(day, e.target.value)} 
